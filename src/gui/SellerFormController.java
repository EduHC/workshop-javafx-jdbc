...
public class SellerFormController implements Initializable {
	...
	public void setSerices(SellerService sellerService, DepartmentService departmentService) {
	...
	public void loadAssocietedObjects() {
		if (departmentService == null) {
			throw new IllegalStateException("Department Service not instancieted");
		}
